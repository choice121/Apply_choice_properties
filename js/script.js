...
class RentalApplication {
    ...
    _showPropertyBanner({ id, name, addr, city, state, rent, beds, baths, deposit, avail, terms, lastMonthsRent, adminFee, moveInSpecial, laundryType, heatingType, coolingType, garageSpaces, evCharging, parkingFee }) {
        ...
        if (lastMonthsRent) chips.push('<span class="pcb-chip"><i class="fas fa-calendar-alt"></i> 
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 + parseFloat(lastMonthsRent).toLocaleString('en-US') + ' Last Mo.</span>');
        if (adminFee)       chips.push('<span class="pcb-chip"><i class="fas fa-receipt"></i> 
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 + parseFloat(adminFee).toLocaleString('en-US') + ' Admin Fee</span>');
        ...
        if (garageSpaces)   chips.push('<span class="pcb-chip"><i class="fas fa-car-side"></i> ' + this._escHtml(garageSpaces) + ' Parking Space(s)</span>');
        ...
        if (parkingFee)     chips.push('<span class="pcb-chip"><i class="fas fa-dollar-sign"></i> 
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 + parseFloat(parkingFee).toLocaleString('en-US') + '/mo Parking</span>');
